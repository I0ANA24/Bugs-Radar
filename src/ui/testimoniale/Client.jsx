...
const Client = () => {
  return (
    <div className="w-100 p-6 space-y-11 border-1 border-[var(--border-color)] rounded-2xl bg-[var(--blueish-background)]">
      <div className='size-30 mx-auto bg-[url("/testimoniale/profile4.avif")] bg-center bg-cover bg-no-repeat rounded-full'></div>
      <div className="space-y-6">
        ...
        <p className="text-gray-600 text-center text-base">— Anna M., Manager firmă DDD</p>
      </div>
    </div>
  );
};
