...
const IntrebariFrecvente = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="w-[100%] sm:w-[85%] md:w-[75%] lg:w-[90%] max-w-180 xl:w-[100%] flex flex-col justify-center items-center border-1 border-[var(--border-color)] rounded-2xl space-y-11 bg-white">
        <div className="space-y-4 w-full m-4 md:m-8">
          <h3 className="text-center text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold">
            Întrebări frecvente
          </h3>
          <p className="text-base sm:text-md md:text-lg lg:text-lg text-center w-full max-w-[90%] mx-auto -mt-2 sm:-mt-0">
