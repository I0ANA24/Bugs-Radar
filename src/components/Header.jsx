      ...
      <div className="w-full flex flex-col gap-2 mx-auto">
        ...
        >
          <nav className="w-full flex flex-col justify-center items-center">
            <a
              href="#beneficii"
              className="h-14 flex justify-center items-center hover:text-[var(--blue)] font-medium text-[var(--title-color)] text-base lg:text-lg xl:text-xl"
              onClick={() => toggleIsOpen()}
            >
              {t("header_nav_benefits")}
            </a>
            ...
            <button
              className="h-14 w-full bg-[var(--blue)] border-2 border-[var(--blue)] text-white font-medium px-4.5 py-2.5 rounded-[4px] hover:bg-[var(--title-color)] hover:border-[var(--title-color)] hover:text-white hover:cursor-pointer transition-colors duration-300 text-base lg:text-lg xl:text-xl"
              onClick={() => toggleIsOpen()}
            >
